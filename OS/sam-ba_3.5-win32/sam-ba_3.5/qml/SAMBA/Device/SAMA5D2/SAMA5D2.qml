...
Device {
	...
	function setActiveROMVersion(version) {
		if ((version === "v1.1 Jul 31 2015 15:09:09") ||
		    (version === "v1.2 Dec  1 2015 09:20:36") ||
		    (version === "v1.3 Oct 28 2016 16:04:43")) {
			activeROMVersion = oldKeys
		} else if (version === "v1.6 Jul  2 2020 07:23:59") {
	...
	*/
	...
	function commandLineCommandWriteFullCustomerKey(args) {
		...
		return connection.executeCustomCommand("WFCK", "write", filename)
	}
