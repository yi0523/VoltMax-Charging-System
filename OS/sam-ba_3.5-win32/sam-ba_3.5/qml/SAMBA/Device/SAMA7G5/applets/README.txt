These SAMA7G5 Applets were built from the Atmel Software Package:
...
2. build the applet (for example: serialflash):
        ...
        make TARGET=sama7g5-generic VARIANT=sram RELEASE=1

3. copy the applet binary to SAM-BA directory
        cp build/applet-serialflash_sama7g5-generic_sram.bin $SAMBADIR/qml/SAMBA/Device/SAMA7G5/applets
